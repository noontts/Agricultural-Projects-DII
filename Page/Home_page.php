        ...
        <div class="static">
          <div class="content-static">
            ...
            <div class="line-3">
                <div class="line-3-1">
                  <div class="text-line">
                    รายรับรายจ่ายรวมของเกษตรกรต่อปี
                  </div>
                  <div class="data-line">
                    150 คน
                  </div>
  ...
  <!--slideshow end-->
    ...
    <div class="announce">
      <div class="announce-content">
        <div class="announce-box-1">
          <div class="announce-head-1">
            ข่าวสารต่างๆ
          </div>
          <div class="announce-text">
            <span class="announce-head-text">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆที่ต้องบอกต่อ</span><br>
            <span style="padding-left: 20px; color: #393939;">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆ ที่เทศบาลเมืองลำพูนร่วมกับหน่วย<br></span>
            <span style="padding-left: 20px; color: #393939;"><a href="#">คลิ้กอ่านต่อ....</a></span>
          </div>
          <div class="announce-text">
            <span class="announce-head-text">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆที่ต้องบอกต่อ</span><br>
            <span style="padding-left: 20px; color: #393939;">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆ ที่เทศบาลเมืองลำพูนร่วมกับหน่วย<br></span>
        ...
        <div class="announce-box-2">
          <div class="announce-head-2">
            กิจกรรมและการจัดอบรม
          </div>
          <div class="announce-text">
            <span class="announce-head-text">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆที่ต้องบอกต่อ</span><br>
            <span style="padding-left: 20px; color: #393939;">ข่วงคนเมือง@ข่วงพันปี กิจกรรมดีๆ ที่เทศบาลเมืองลำพูนร่วมกับหน่วย<br></span>
